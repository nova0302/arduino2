...
* 학습목표
  ...
  - PIR 센서의 동작 원리를 이해하고, 제어하여 할 수 있다.
  - RF ID의 동작 원리를 이해하고, 제어하여 할 수 있다.
  - Bluetooth 모듈의 동작 및 원리를 이해하고, 제어하여 스마트폰과 통신 할 수 있다.
  - UART 모듈의 동작 및 원리를 이해하고, 제어하여 컴퓨터와 통신 할 수 있다.
